...
- A from and a to filter over the same columns are one range: both bounds must hold for the same related row, so a row before the range and another after it no longer match.
...
- Make search box remember history.
...
- Truncate export entries when over limit.

## [5.3.1] - 2026-07-09

### Fixed

- Explain the exceeded export limit in a JS alert on button click.
...
- Lift the PHP execution time limit while streaming a CSV export.
- Add a top margin between the table and the CSV download button.
- Fix the CSV download button icon with FontAwesome SVG replacement.
...
- Apply preprocessor also to free text search.
...
- Show no results in which columns"

## [4.1.3] - 2026-05-12

### Fixed

- Fix pagination count for complex queries.

## [4.1.2] - 2026-04-07

### Fixed

- Add restrict option for options filter type, do not restrict by default.
...
- Allow decimal point numbers in number filters.
...
## [3.2.0-rc.1] - 2026-02-25

### Changed

- Update laravel-common to v5.
...
[7.2.0-rc.1]: https://github.com/internetguru/laravel-model-browser/releases/tag/v7.1.0
...
[6.1.0]: https://https://github.com/internetguru/laravel-model-browser/compare/v6.0.1...v6.1.0
[6.1.0-rc.1]: https://github.com/internetguru/laravel-model-browser/releases/tag/v6.0.1
...
[4.1.1]: https://https://github.com/internetguru/laravel-model-browser/compare/v4.1.0...v4.1.1
...
[3.2.0-rc.1]: https://github.com/internetguru/laravel-model-browser/releases/tag/v3.1.9
